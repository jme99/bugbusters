		...
		do {
			try {
				...
				if (bf.ready()) {
					...
					// get number of parameters and put them in an array of
					// String:
					...
					case RADAR:
						...
						case SHOT:
							if (salve < maxSalve) {
								...
								// if (robotDistance>2)
								// sendCommand("RotateAmount "+ROT_ROBOT+" "+rotate/3+" "+1/robotDistance/4);
							} else {
								sendCommand("Rotate " + ROT_ROBOT + " 0");
							}
							break;
